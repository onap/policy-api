...
# Select branch
source ${SCRIPTS}/csit/policy-csit.sh
...
bash ${SCRIPTS}/csit/get-models-examples.sh

source ${SCRIPTS}/csit/detmVers.sh
...
docker-compose -f ${SCRIPTS}/csit/docker-compose-all.yml up -d api
...
${SCRIPTS}/csit/wait_for_port.sh ${POLICY_API_IP} 6969
