...
public class TestApiRestServer {
    ...
    public void testNamingPolicyGet() throws Exception {
        ...
        // TODO: Enable in Guilin
        /*
         * ToscaServiceTemplate namingServiceTemplate = rawResponse.readEntity(ToscaServiceTemplate.class);
         * assertEquals(1, namingServiceTemplate.getToscaTopologyTemplate().getPoliciesAsMap().size()); assertEquals(1,
         * namingServiceTemplate.getPolicyTypesAsMap().size()); assertEquals(3,
         * namingServiceTemplate.getDataTypesAsMap().size());
         *
         * rawResponse = readResource("policytypes/onap.policies.Naming/versions/1.0.0/" +
         * "policies/SDNC_Policy.ONAP_VNF_NAMING_TIMESTAMP/versions/latest?mode=referenced", APP_JSON);
         * assertEquals(Response.Status.OK.getStatusCode(), rawResponse.getStatus());
         *
         * namingServiceTemplate = rawResponse.readEntity(ToscaServiceTemplate.class); assertEquals(1,
         * namingServiceTemplate.getToscaTopologyTemplate().getPoliciesAsMap().size()); assertEquals(1,
         * namingServiceTemplate.getPolicyTypesAsMap().size()); assertEquals(3,
         * namingServiceTemplate.getDataTypesAsMap().size());
         *
         * rawResponse = readResource("policytypes/onap.policies.Naming/versions/1.0.0/policies?mode=referenced",
         * APP_JSON); assertEquals(Response.Status.OK.getStatusCode(), rawResponse.getStatus());
         *
         * namingServiceTemplate = rawResponse.readEntity(ToscaServiceTemplate.class); assertEquals(1,
         * namingServiceTemplate.getToscaTopologyTemplate().getPoliciesAsMap().size()); assertEquals(1,
         * namingServiceTemplate.getPolicyTypesAsMap().size()); assertEquals(3,
