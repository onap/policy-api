 ...
 * (Gson) contract to hold, because {@link org.onap.policy.api.main.PolicyApiApplication} excludes
 * Jackson auto-configuration: with no {@code JsonMapper} bean present the Boot-provided Jackson
 * message converter (which is {@code @ConditionalOnBean} on that mapper) drops out and Gson is used
