...
public class PolicyProvider extends CommonModelProvider {
    ...
    public ToscaServiceTemplate createPolicy(String policyTypeId, String policyTypeVersion,
        ...
        policyValidator.validatePoliciesAgainstPolicyTypes(body.getToscaTopologyTemplate().getPoliciesAsMap());
        policyValidator.validateNativePolicies(body.getToscaTopologyTemplate().getPoliciesAsMap());
