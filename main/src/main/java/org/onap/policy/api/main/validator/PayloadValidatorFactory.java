...
public class PayloadValidatorFactory {
    ...
    /**
     * Creates a payload validator.
     *
     * @param parameters the parameters including the implementation class of generic payload validator
     * @return an implemented payload validator
     * @throws PfModelException on errors creating an implemented payload validator
     */
