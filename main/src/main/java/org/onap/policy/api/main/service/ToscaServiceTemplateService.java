...
public class ToscaServiceTemplateService {
    ...
    public ToscaServiceTemplate deleteToscaNodeTemplate(@NonNull final String name, @Nonnull final String version)
        ...
        //Verify if the node template is referenced in the metadata of created policies
        assertNodeTemplateNotUsedInPolicy(name, version);
     ...
     */
    private void verifyNodeTypeInDbTemplate(final JpaToscaNodeTemplate toscaNodeTemplate) throws
        PfModelException {
     ...
     */
    private void assertNodeTemplateNotUsedInPolicy(String name, String version)
        throws PfModelException {
        JpaToscaServiceTemplate dbTemplate;
        try {
            //Retrieve all the policies from db, return if policies doesn't exist
            dbTemplate = getDefaultJpaToscaServiceTemplate();
