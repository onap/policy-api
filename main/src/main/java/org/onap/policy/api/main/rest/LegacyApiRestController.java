...
public class LegacyApiRestController {
    ...
    public Response getAllGuardPolicies(
        ...
        try {
            PlainToscaServiceTemplate serviceTemplate = new LegacyGuardPolicyProvider().fetchGuardPolicies(null, null);
    ...
    public Response getAllVersionsOfGuardPolicy(
        ...
        try {
            PlainToscaServiceTemplate serviceTemplate = new LegacyGuardPolicyProvider()
    ...
    public Response createGuardPolicy(
        ...
        try {
            PlainToscaServiceTemplate serviceTemplate = new LegacyGuardPolicyProvider().createGuardPolicy(body);
            return addLoggingHeaders(addVersionControlHeaders(Response.status(Response.Status.OK)), requestId)
                    .entity(serviceTemplate).build();
        } catch (PfModelException pfme) {
            return addLoggingHeaders(addVersionControlHeaders(
    ...
    public Response getAllOperationalPolicies(
        ...
        try {
            PlainToscaServiceTemplate serviceTemplate = new LegacyOperationalPolicyProvider()
