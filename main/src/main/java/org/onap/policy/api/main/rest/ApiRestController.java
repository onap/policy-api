...
import org.onap.policy.api.main.rest.provider.StatisticsReport;
...
public class ApiRestController {
    ...
    @ApiOperation(value = "Retrieve one particular version of a policy type",
            ...
            response = ToscaPolicyType.class,
            authorizations = @Authorization(value = "basicAuth"),
            tags = { "PolicyType", })
    @ApiResponses(value = {
            @ApiResponse(code = 401, message = "Authentication Error"),
     ...
     *
     * @param policyTypeId the ID of specified policy type
     * @param policyTypeVersionId the version of specified policy type
     *
     * @return the Response object containing the results of the API operation
     */
    @GET
     ...
     * @param policyTypeVersionId the version of specified policy type
     * @param policyId the ID of specified policy
     * @param policyVersionId the version of specified policy
     *
     * @return the Response object containing the results of the API operation
     */
    @GET
    ...
    /**
     * Retrieves the deployed version of a particular policy.
     *
     * @param policyTypeId the ID of specified policy type
     * @param policyTypeVersionId the version of specified policy type
     * @param policyId the ID of specified policy
    ...
    public Response deleteOneVersionOfPolicy(@PathParam("policyTypeId") @ApiParam("PolicyType ID") String policyTypeId,
            @PathParam("policyTypeVersionId") @ApiParam("ID of policy type version") String policyTypeVersionId,
            @PathParam("policyId") @ApiParam("ID of policy") String policyId,
            @PathParam("policyVersionId") @ApiParam("ID of policy version") String policyVersionId) {
        return Response.status(Response.Status.OK)
